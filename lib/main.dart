...
import 'package:health_card/screens/splash_screen.dart';
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          ...
          caption: TextStyle(color: Colors.red[700], fontSize: 12),
        ),
      ),
